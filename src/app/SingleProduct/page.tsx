...
const SingleProduct = () => {
  return (
    <div className="h-[1333px] my-10 bg-white">
      <div className="flex flex-row  mx-20 gap-[120px]">
        ...
        <div className="h-[615px]">
          <div className="absolute w-[441px] h-[132px] top-[235px] font-inter text-[60px] font-bold leading-[66px] text-[rgba(39,35,67,1)]">
            Library Stool Chair
          </div>
          <div className="w-[120px] absolute  h-[42px] items-center pt-2 pl-3 rounded-3xl bg-[rgba(2,159,174,1)] top-[400px] font-inter text-[18px] font-semibold leading-[22px] text-white">
            $20.00 USD
          </div>
          <div className="absolute w-[423px] border-t h-[101px] pt-5 top-[468px] font-inter text-[rgba(39,35,67,1)] text-[22px] font-normal leading-[33px] opacity-[0.6]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
            tincidunt erat enim. Lorem ipsum dolor sit amet, consectetur
            adipiscing
          </div>
          <Button className="w-[171px] h-[52px]   bg-[rgba(2,159,174,1)] absolute top-[640px]  p-[14px_24px] gap-[20px] rounded-tl-[8px]">
      ...
      <div className="flex flex-row  mx-20 gap-[74px]">
      ...
      <div className="flex mt-10 mb-10  mx-20 flex-row gap-10">
        <div className="h-[307px]  bg-white w-[242px]">
          <div
